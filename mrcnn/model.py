...
def build_fpn_mask_graph(rois, feature_maps, image_meta,
    ...
    if mask_shape[0] > 28:
        ...
        for i in range(repetitions):
            x = KL.TimeDistributed(KL.Conv2DTranspose(256, (2, 2), strides=2, activation="relu"),
                           name="mrcnn_mask_deconv_{0}".format(i+2))(x)
...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        sc5_P4 = KL.UpSampling2D(size=(2, 2), name="sc_p5upsampled_2")(C5)
        sc5_P3 = KL.UpSampling2D(size=(4, 4), name="sc_p5upsampled_4")(C5)
        sc5_P2 = KL.UpSampling2D(size=(8, 8), name="sc_p5upsampled_8")(C5)
        ...
        P3 = KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (3, 3), padding="SAME", name="fpn_p3")(final_P3)
        P4 = KL.Conv2D(config.TOP_DOWN_PYRAMID_SIZE, (3, 3), padding="SAME", name="fpn_p4")(final_P4)
